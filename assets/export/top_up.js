...
// *
// * TopUp 1.1 - The #1 Javascript Pop Up (Uncompressed)
// *
// * Copyright (c) 2009 Paul Engel (Internetbureau Holder B.V.)
// * All rights reserved
// *
// * $Date: 2009-01-06 23:09:05 +0100 (Tue, 06 January 2009) $
// *
...
TopUp = function() {
	...
	var injectCode = function() {
		...
		var html = '<div id="tu_overlay" style="display: none"></div><div id="top_up" class="tu_top_up" style="display: none"><div class="tu_wrapper"><a class="tu_close_link" onclick="TopUp.close()" style="display: none"></a><div class="tu_title"></div><table class="tu_frame"><tr class="tu_top"><td class="tu_left tu_corner"></td><td class="tu_middle tu_rib"></td><td class="tu_right tu_corner"></td></tr><tr class="tu_middle"><td class="tu_left tu_rib"></td><td class="tu_middle"><div class="tu_content"><!-- Content --></div></td><td class="tu_right tu_rib"></td></tr><tr class="tu_bottom"><td class="tu_left tu_corner"></td><td class="tu_middle tu_rib"></td><td class="tu_right tu_corner"></td></tr></table><div class="tu_bottom_bar"><div class="tu_controls_wrapper"><div class="tu_controls"><a class="tu_previous_link" onclick="TopUp.previous()" style="display: none"><span class="tu_previous_caption">Previous</span></a><a class="tu_next_link" onclick="TopUp.next()" style="display: none"><span class="tu_next_caption">Next</span></a></div></div></div></div></div><div id="temp_up" class="tu_top_up"><div class="tu_wrapper"><a class="tu_close_link" onclick="TopUp.close()" style="display: none"></a><div class="tu_title"></div><table class="tu_frame"><tr class="tu_top"><td class="tu_left tu_corner"></td><td class="tu_middle tu_rib"></td><td class="tu_right tu_corner"></td></tr><tr class="tu_middle"><td class="tu_left tu_rib"></td><td class="tu_middle"><div class="tu_content"><!-- Content --></div></td><td class="tu_right tu_rib"></td></tr><tr class="tu_bottom"><td class="tu_left tu_corner"></td><td class="tu_middle tu_rib"></td><td class="tu_right tu_corner"></td></tr></table><div class="tu_bottom_bar"><div class="tu_controls_wrapper"><div class="tu_controls"><a class="tu_previous_link" onclick="TopUp.previous()" style="display: none"><span class="tu_previous_caption">Previous</span></a><a class="tu_next_link" onclick="TopUp.next()" style="display: none"><span class="tu_next_caption">Next</span></a></div></div></div></div></div><table id="tu_center_wrapper" style="display: none"><tr valign="middle"><td id="tu_centered_content" align="center"><!-- tu_top_ups --></td></tr></table>';
