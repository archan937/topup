...
function deriveScriptElement() {
	var id = "tu_dummy_script";
	document.write('<script id="' + id + '"></script>');

	var dummyScript = document.getElementById(id);
	var scriptElement = dummyScript.previousSibling;
...
var scriptElement = deriveScriptElement();

// *
// * TopUp 1.5 (Uncompressed)
...
// *
// * $Date: 2009-03-28 14:02:11 +0100 (Sat, 28 March 2009) $
// *
...
(function () {
  try { jQuery } catch(e) {
    var src = scriptElement.getAttribute("src").replace(/top_up\.js.*$/, "jquery.js");
